...
第一阶段： 应用梳理、评估阶段。
     ...
     本阶段任务及目的：
       ...
       本阶段主要目的为在接收到容器化需求后，
        ...
        要素一： 通过设置标准化的需求调研表格，以达成容器平台运维方与应用所有方有一个标准的沟通界面。

        要素二： 在达成如上目标的情况下，就应用容器最终落定的形式及方式双方人员有效沟通，达成初步共识。

        要素三：在达成技术实现共识的基础上，确定具体执行人员及具体工作进度安排表

　本阶段双方职责划分、工作时间进度规划、参与人员技能需求说明。

　　

　本阶段表格设计：（分为两个部署，正常流程表格、阶段最终交付物表格）
